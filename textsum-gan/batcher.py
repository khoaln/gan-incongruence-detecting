...
class Batch(object):
    ...
    def init_encoder_seq(self, example_list, hps):
        ...
        self.enc_weight_mask = np.zeros((hps.batch_size.value, max_enc_seq_len), dtype=np.float32)
    ...
    def init_decoder_seq(self, example_list, hps):
        ...
        self.batch_reward = np.zeros((hps.batch_size.value, hps.max_dec_steps.value), dtype=np.float32)
        self.batch_rouge_reward = np.zeros((hps.batch_size.value, 1), dtype=np.float32)
